...
decay_sim1 <- ggarrange(pic_choice_trials1, pic_accre_trials1, ncol = 2, nrow = 1, labels = c("A", "B"),
                     widths = c(1.25, 1), heights = 1)

ggsave(filename = "./pic/decay_sim1.png", plot = decay_sim1, 
       width = 11, height = 5.5)
...
ggsave(filename = "./pic/decay_v_plot.png", plot = v_plot, 
       width = 9, height = 5.5)
